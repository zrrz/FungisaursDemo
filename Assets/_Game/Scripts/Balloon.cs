...
public class Balloon : MonoBehaviour
{
	...
	void Start()
	{
        ...
        floorLevel = FungisaurManager.instance.GetCurrentFungisaur().transform.Find("Plane").transform.position.y + .01f;
	...
	void Update()
	{
        ...
        {
            BalloonGameManager.instance.EndBalloonGame();
        }
	}
 ...
 //       GetComponent<Rigidbody>().position += velocity*Time.fixedDeltaTime;
    ...
    IEnumerator KnockUp() {
        ...
        int ballonGameScore = BalloonGameManager.instance.balloonGameScore;
        ...
        if(!knockingUp) {
            ...
            BalloonGameManager.instance.AddBalloonPoint();
